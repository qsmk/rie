...
public class MusicPlayerActivity extends AppCompatActivity {
    ...
    private ImageButton prevBtn, playPauseBtn, nextBtn,listBtn;
    ...
    void init() {
        ...
        listBtn = findViewById(R.id.btn_list);//定义歌单
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btn_prev:
                    ...
                    playPauseBtn.setImageResource(R.drawable.start); // 切换成暂停键
                    animator.start();
                    if (!player.isPlaying()) {
                ...
                case R.id.btn_play_pause:
                    ...
                    if (!isPausing && !isPlaying) { // 暂停状态，且从未被播放
                        // 开始播放
                        playPauseBtn.setImageResource(R.drawable.play1); // 切换成暂停键
                        animator.start();
                        prepareMedia();
                        isPlaying = true;
                        ...
                        // 暂停播放
                        playPauseBtn.setImageResource(R.drawable.start); // 切换成播放键
                        animator.pause();
                        player.pause();
                    }
